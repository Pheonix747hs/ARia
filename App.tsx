  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="SplashScreen">
        <Stack.Screen name="SplashScreen" component={SplashScreenNew} options={{ headerShown: false }} />
        ...
        <Stack.Screen name="ARSceneScreen" component={ARSceneScreenNew as React.FC<any>} options={{ headerShown: false }} />
